let wraper_myOrder = document.querySelector('.wraper_myCart_order')
    ...
    .then(data => {
        if(data.length){
            ...
            data.forEach(item => {
                ...
                wraper_myOrder.insertAdjacentHTML('beforeend',`
            ...
            location.href = "http://127.0.0.1:5500/html/myorderEmpty.html"
        }
            
    })
}
window.addEventListener('load',creatOrderlist)
